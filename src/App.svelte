<script>
  ...
  setTimeout(()=> {
    ...
    rows = [
      { name: 'Diego', id: 0, data: {provider: 'github.com'}, socialNetwork: '1facebook.com', date: randomDate() },
      { name: 'a', id: 1, data: {provider: 'github.com'}, socialNetwork: '2facebook.com', date: randomDate() },
      { name: 'b', id: 2, data: {provider: 'github.com'}, socialNetwork: '3facebook.com', date: randomDate() },
      ...
      { name: 'jan', id: 8, data: {provider: 'github.com'}, socialNetwork: '9facebook.com', date: randomDate() },
      { name: 'jna', id: 9, data: {provider: 'github.com'}, socialNetwork: '10facebook.com', date: randomDate() },
      { name: 'janu', id: 10, data: {provider: 'github.com'}, socialNetwork: '11facebook.com', date: randomDate() },
      { name: 'jua ablo', id: 11, data: {provider: 'github.com'}, socialNetwork: '12facebook.com', date: randomDate() },
      { name: 'uan Pablo', id: 12, data: {provider: 'github.com'}, socialNetwork: '13facebook.com', date: randomDate() },
      { name: 'Juan Pablo', id: 13, data: {provider: 'gitlab.com'}, socialNetwork: '14google+.com', date: randomDate() },
      { name: 'Juan Pablo', id: 14, data: {provider: 'gitlab.com'}, socialNetwork: '15google+.com', date: randomDate() },
    ];
  }, 2)
</script>
